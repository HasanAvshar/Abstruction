...
public:
	...
	virtual void Print() const = 0 {
		...
		cout << "Model: " << (_model != nullptr ? *_model : "nullptr") << endl;
		cout << "Vendor: " << (_vendor != nullptr ? *_vendor : "nullptr") << endl;
		cout << "Has Spoiler: " << (_hasSpoiler != nullptr ? (*_hasSpoiler ? "true" : "false") : "nullptr") << endl;
	}
...
void main()
{
	...
	cars.push_back(new Manual("Mercedes", "S-100B", true, false, 4, 300));
	cars.push_back(new Automatic(false, 250, true, "Prado", "S-100A"));
	cars.push_back(new Bmw("Series1", "ModelType1", true, 200, false, "X1-A2", "BMW-A2"));
